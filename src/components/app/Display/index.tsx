    ...
    <motion.div className={classnames((section !== "display" && section !== "saved") && "hidden")}>
      ...
      <div className="space-y-2.5">
        <div className="flex space-x-2.5 mt-8">
          <Button onClick={saveImg} className="flex justify-center items-center space-x-2.5 border border-TUCMC-gray-600 rounded-md text-TUCMC-gray-600 px-4 py-5 w-1/2 cursor-pointer">
